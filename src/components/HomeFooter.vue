<template lang="">
  <div class="HomeFooter">
    <div class="HomeFooter__container container">
      <a rel="noreferrer" target="_blank" href="https://www.gdgph.org/" class="HomeFooter__logo">
        <img class="HomeFooter__logo-image" alt="Google Developer Group Philippines" src="/assets/logo-only-colored.svg">
        <span class="HomeFooter__logo-text">GDG Philippines</span>
      </a>
    

    <ul class="HomeFooter__links">
      <li class="HomeFooter__item">
        <a rel="noreferrer" target="_blank" aria-label="Medium.com" href="https://www.meetup.com/gdgphilippines/" class="HomeFooter__link">
      ...
      <li class="HomeFooter__item">
        <a rel="noreferrer" target="_blank" aria-label="Twitter" href="https://twitter.com/gdgphilippines" class="HomeFooter__link">
          <svg style="width:24px;height:24px" viewBox="0 0 24 24">
      ...
      <li class="HomeFooter__item">
        <a rel="noreferrer" target="_blank" aria-label="Facebook" href="https://www.facebook.com/gdgphilippines" class="HomeFooter__link">
          <svg style="width:24px;height:24px" viewBox="0 0 24 24">
    <path d="M5,3H19A2,2 0 0,1 21,5V19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19V5A2,2 0 0,1 5,3M18,5H15.5A3.5,3.5 0 0,0 12,8.5V11H10V14H12V21H15V14H18V11H15V9A1,1 0 0,1 16,8H18V5Z" />
      ...
      <li class="HomeFooter__item">
        <a rel="noreferrer" target="_blank" aria-label="Instragram" href="https://www.instagram.com/gdgphilippines/" class="HomeFooter__link">
          <svg style="width:24px;height:24px" viewBox="0 0 24 24">
